        ...
        if Fetch_Data == 1:
            for k in range(1):
                ...
                if Test_Pattern_Mode_Output == 0:
                    filename = "Array_T_Pixel=%d_DAC_P%d=%d_DAC_P5=402_QSel=%d_CLSel=%d_RfSel=%d_IBSel=%d_PhaseAdj=%03d_B%s_%s_%s"%(Pixel_Num, Pixel_Num, DAC_Pixel, QSel, CLSel, RfSel, IBSel, PhaseAdj, Board_num, Total_point*50000, time_stampe)
                else:
