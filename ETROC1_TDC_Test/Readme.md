...
![KC705 EVB](https://github.com/weizhangccnu/ETROC1_Test/blob/master/ETROC1_TDC_Test/Img/KC705_EVB.png) 
  ...
  - Configure PC IP address. The PC network IP address and FPGA IP address should be in the same network segment and the default PC network IP address is **192.168.2.254**. The subnet mask of PC should be set to **255.255.255.0**
