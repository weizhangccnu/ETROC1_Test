...
![KC705 EVB](https://github.com/weizhangccnu/ETROC1_Test/blob/master/ETROC1_TDC_Test/Img/KC705_EVB.png) 
  - Configure KC705 EVB download mode and download `kc705_mig.bit` or `kc705_mig.bit` file into KC705 EVB. The DIP switch **SW13** position 3,4, and 5 control determin the configuration mode and the configuration mode is used at power-up or when the PROG pushbutton is pressed. The SW13 should be set as shown the below figure.
